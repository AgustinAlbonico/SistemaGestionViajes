  ...
  return (
    <header className="w-full h-16 absolute top-0 left-0 bg-[#820486]">
      <nav className="w-[90%] h-full flex justify-between items-center mx-auto">
        <p className="text-xl sm:text-2xl text-white font-bold">Bienvenido, {data?.userDb.nombre}!</p>
        <button
          onClick={handleLogout}
          className="bg-white px-4 py-2 sm:text-xl rounded-lg text-sm border-[1px] border-[#725ba7] text-[#725ba7] hover:bg-[#725ba7] hover:text-white transition-all duration-300 font-bold"
        >
          Cerrar Sesión
        </button>
      </nav>
